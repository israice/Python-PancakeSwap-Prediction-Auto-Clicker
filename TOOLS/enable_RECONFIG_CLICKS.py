...
# ==== Настройки ====
FILE_PATH = "CORE/AA_RECONFIG_CLICKS.yaml"   # путь к файлу с ПРЯМЫМИ слэшами
KEY_NAME  = "AA_RECONFIG_CLICKS"     # имя ключа в YAML
NEW_VALUE = "on"             # слово для записи (будет без кавычек)
# ===================
