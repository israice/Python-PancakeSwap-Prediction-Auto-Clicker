# -*- coding: utf-8 -*-
"""
Pancake Prediction (BNB) без браузера.
Корректная схема из 2 вызовов:
  1) currentEpoch()
  2) rounds(epoch) -> lockTimestamp, closeTimestamp
Таймер = время до ближайшего события (lock, затем close) и всегда <= 05:00.
Записывает ТОЛЬКО значение ключа CANDLE_TIME в settings.yaml.
"""
...
# НАСТРОЙКИ
# =========================
SETTINGS_PATH = "settings.yaml"   # только прямые слэши
