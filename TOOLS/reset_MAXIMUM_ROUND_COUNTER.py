...
# ==== Настройки ====
FILE_PATH = "CORE/C_RELOAD_ALL.yaml"   # путь к файлу с ПРЯМЫМИ слэшами
KEY_NAME  = "MAXIMUM_ROUND_COUNTER"     # имя ключа в YAML
NEW_VALUE = "1"             # слово для записи (будет без кавычек)
# ===================
