...
YAML_KEY_RUNNER = "RUNNER_RELOAD_ORDER"
RUNNER_ON_VALUE = "on"

MAIN_SCRIPTS = [
    {"print": "CHECK CANDLE..."},
    "CORE/D_FLOW/B_RELOAD_ORDER/tools/get_PANCAKE_TIMER_DATA.py",
    "CORE/D_FLOW/B_RELOAD_ORDER/BA_CHECK_IF_CANDLE_TIME_IS_3.py",
    "CORE/D_FLOW/B_RELOAD_ORDER/BB_if_true.py",
    "CORE/D_FLOW/B_RELOAD_ORDER/tools/SYSTEM_LARGE_DELAY_IN_SECONDS.py",
]
# ==============================================
