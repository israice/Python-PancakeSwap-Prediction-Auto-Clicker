...
# ==============================
SETTINGS_FILE = "CORE/C_RELOAD_ALL.yaml"         # путь к файлу настроек
VAR_COORDS   = "CLICK_WINNINGS_COLOR"     # имя переменной с координатами
VAR_RESULT   = "WININGS_COLOR"           # ключ, куда записываем результат

VALUE_GREEN_WORD = "true"
VALUE_RED_WORD   = "false"
VALUE_ZERO_WORD  = "WRONG_PIXEL"               # <-- записываем это, если ни один цвет не совпал

COLOR_GREEN_HEX = "#228E99"
COLOR_RED_HEX   = "#27262C"
