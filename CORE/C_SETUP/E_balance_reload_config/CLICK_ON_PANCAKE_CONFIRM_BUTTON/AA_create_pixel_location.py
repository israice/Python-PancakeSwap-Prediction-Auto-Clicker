...
# Настройки
IMAGE_PATH = "CORE/C_SETUP/CLICK_ON_PANCAKE_CONFIRM_BUTTON/AB_image.png"
...
VARIABLE_NAME = "CLICK_ON_PANCAKE_CONFIRM_BUTTON"  # Имя переменной для сохранения координат
