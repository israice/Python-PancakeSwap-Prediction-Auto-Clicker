...
# Настройки
IMAGE_PATH = "CORE/C_SETUP/CLICK_CANDLE_COLOR/AA_image_CLICK_CANDLE_COLOR.png"
SCALE_FACTOR = 1  # Уменьшение размера в 2 раза (50%)
BORDER_OFFSET = 10  # Отступ от края экрана в пикселях
POSITION = "bottom_right"  # Варианты: "top_left", "bottom_left", "top_right", "bottom_right"
SETTINGS_FILE = "CORE/Y_DATA/C_flow.yaml"  # Путь к файлу настроек
VARIABLE_NAME = "CLICK_CANDLE_COLOR"  # Имя переменной для сохранения координат
