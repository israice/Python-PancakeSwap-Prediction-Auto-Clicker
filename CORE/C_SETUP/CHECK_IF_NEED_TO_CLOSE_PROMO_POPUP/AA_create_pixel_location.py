...
# Настройки
IMAGE_PATH = "CORE/C_SETUP/CHECK_IF_NEED_TO_CLOSE_PROMO_POPUP/AB_image.png"
...
VARIABLE_NAME = "CHECK_IF_NEED_TO_CLOSE_PROMO_POPUP"  # Имя переменной для сохранения координат
