...
# Настройки
IMAGE_PATH = "CORE/C_SETUP/CLICK_FINISH_AND_CLOSE_METAMASK/AB_image.png"
...
VARIABLE_NAME = "CLICK_FINISH_AND_CLOSE_METAMASK"  # Имя переменной для сохранения координат
