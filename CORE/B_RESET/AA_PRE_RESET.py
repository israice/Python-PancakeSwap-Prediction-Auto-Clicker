...
YAML_KEY_RUNNER = "RUNNER_PRE_RESET"
RUNNER_ON_VALUE = "on"

MAIN_SCRIPTS = [
    {"print": "PRE RESET..."},
    "CORE/B_RESET/tools/reset_ALL_ROUNDS_COUNTER.py",
    "CORE/B_RESET/tools/get_METAMASK_BNB_BALANCE.py",
    "CORE/B_RESET/tools/create_INSERT_AMMOUNT_IN_BNB.py",
    # ################################
    "CORE/B_RESET/tools/disable_PRE_RESET.py",
]
# ==============================================
