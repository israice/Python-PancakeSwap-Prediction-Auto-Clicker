...
# ================= НАСТРОЙКИ =================
SETTINGS_FILE = "CORE/A_RESET.yaml"
YAML_KEY_RUNNER = "A_RESET"
RUNNER_ON_VALUE = "on"

MAIN_SCRIPTS = [
    {"print": "RESET..."},
    "TOOLS/reset_MAXIMUM_ROUND_COUNTER.py",
    # ###################################
    "CORE/AA_PRE_RESET.py",
    "CORE/AB_RECONFIG_CLICKS.py",
    # ###################################
    "TOOLS/disable_RESET.py",
]
# ==============================================
